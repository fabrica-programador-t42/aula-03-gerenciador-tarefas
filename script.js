...
function construirNovoItem(id, valor){
return `<div id="${id}" class="item">
        ...
        <div class="item-botao">
            <button onclick="deletar(${id})" class="delete"><i class="mdi mdi-user"></i> Deletar</button>
        </div>
    </div>`;
}
...
function addTarefa() {
  ...
  if (valorInput !== "" && valorInput !== null && valorInput !== undefined) {
    ...
    let novoItem = construirNovoItem(contador, valorInput)
